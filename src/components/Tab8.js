              ...
              <div className="card boxsh" key={item.id}>
                <Link to={`/${item.id}`}>
                  ...
                  >
                    ...
                    <SwiperSlide>
                      <img
                        src={item.carouselPic1}
                        className="cardImg"
                        alt="Additional view 1 of the home"
                      />
                    </SwiperSlide>

                    <SwiperSlide>
                      <img
                        src={item.carouselPic2}
                        className="cardImg"
                        alt="Additional view 2 of the home"
                      />
                    </SwiperSlide>

                    <SwiperSlide>
                      <img
                        src={item.carouselPic3}
                        className="cardImg"
                        alt="Additional view 3 of the home"
                      />
                    </SwiperSlide>

                    <SwiperSlide>
                      <img
                        src={item.carouselPic4}
                        className="cardImg"
                        alt="Additional view 4 of the home"
                      />
                    </SwiperSlide>

                    <SwiperSlide>
                      <img
                        src={item.carouselPic5}
                        className="cardImg"
                        alt="Additional view 5 of the home"
                      />
                    </SwiperSlide>
                  </Swiper>
